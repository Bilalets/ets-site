    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "fixed z-[9999] bg-gray-400 !bg-opacity-80 shadow-sticky backdrop-blur-sm transition dark:bg-gray-dark dark:shadow-sticky-dark"
                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="relative">
                        {menuItem.path ? (
                          ...
                          <p className="flex cursor-pointer items-center py-2 text-base text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:py-6">
                            {menuItem.title}
                          </p>
                        )}
                      </li>
